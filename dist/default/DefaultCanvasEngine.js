...
var DefaultCanvasEngine = /** @class */ (function () {
    ...
    DefaultCanvasEngine.prototype.runNextTick = function () {
        return __awaiter(this, void 0, void 0, function () {
            var painterModuleIndex, painterModule, painter, x, y, color, direction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        // Run the painter
                        painter.next(this.state, x, y);
                        color = painter.getLastActionColor();
                        direction = painter.getLastActionDirection();
    ...
    DefaultCanvasEngine.prototype.getPainterInstance = function (painterModuleIndex) {
        return __awaiter(this, void 0, void 0, function () {
            var moduleImportEnv, moduleImportCommon, painterModule, wasmInstance, painterInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        moduleImportEnv = {
                            abort: function () { return console.error("Painter " + painterModuleIndex + " aborted!"); }
                        };
                        moduleImportCommon = {
                            log: function (message) { return console.log(message); }
                        };
                        painterModule = this.painterModules[painterModuleIndex];
                        return [4 /*yield*/, WebAssembly.instantiate(painterModule, { common: moduleImportCommon, env: moduleImportEnv })];
                    case 1:
                        wasmInstance = _a.sent();
                        painterInstance = wasmInstance.exports;
                        if (!(0, DefaultPainter_1.objIsDefaultPainter)(painterInstance))
                            throw new Error("Painter #" + painterModuleIndex + " is not valid");
                        // Initialize the painter 
                        painterInstance.init(this.width, this.height);
                        this.painterInstances[painterModuleIndex] = painterInstance;
                        _a.label = 2;
                    case 2: return [2 /*return*/, this.painterInstances[painterModuleIndex]];
                }
            });
        });
    };
